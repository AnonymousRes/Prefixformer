...
from fairseq.models.speech_commands.prefixformer_scraw_encoder import PrefixformerSCEncoder
...
class SCRawEncoder(FairseqEncoder):
    ...
    def __init__(self, args, task):
        ...
        if args.layer_type == 'mega':
            ...
            self.encoder = PrefixformerSCEncoder(
                num_encoder_layers=args.encoder_layers,
                embedding_dim=args.encoder_embed_dim,
                ffn_hidden_dim=args.encoder_ffn_embed_dim,
...
@register_model_architecture('sc_raw', 'prefixformer_sc_raw')
def prefixformer_lra_sc(args):
    args.apply_bert_init = getattr(args, 'apply_bert_init', False)
